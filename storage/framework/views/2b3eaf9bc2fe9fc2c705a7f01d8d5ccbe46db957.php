...
>
  <div class="card">
    ...
    <span class="cursor gray"
          ng-if="his.id == Question.current_question.user_id">
      [: Question.current_question.id :]
      <span ng-click="Question.remove(Question.current_question.id)">
        删除问题
      </span>
      <span ng-click="Question.show_update_form = !Question.show_update_form"
      >
        <span ng-if="Question.show_update_form">取消
        </span>修改问题</span>
      </span>
          ...
          <div>[: item.content :]
            <div class="action-set">
              <span ng-click="item.show_comment=!item.show_comment">
                <span ng-if="item.show_comment">取消</span>
                评论
              </span>
    ...
    <div>
      ...
      <div>
        <p class="input-error-set" ng-if="Answer.delete_num == 1">
          评论已被成功删除
        </p>
        <p class="input-error-set" ng-if="Answer.delete_num == 2">
          回答已被成功删除
        </p>
